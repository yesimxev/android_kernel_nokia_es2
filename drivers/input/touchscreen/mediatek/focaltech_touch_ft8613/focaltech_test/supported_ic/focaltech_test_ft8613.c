...
int ft8716_rawdata_test(bool *test_result)
{
    ...
    //----------------------------------------------------------Return Result
    FTS_TEST_SAVE_INFO_RESULT("RawData Test is %s\n", (temp_result ? "OK" : "NG"));
...
RAWDATA_TEST_ERR:
    *test_result = false;
    FTS_TEST_SAVE_INFO_RESULT("=RAWDATA Test is NG\n");
    return ret;
}
...
int ft8716_cb_test(bool *test_result)
{
    ...
    FTS_TEST_SAVE_INFO_RESULT("CB Test is %s\n", (temp_result ? "OK" : "NG"));
...
CB_TEST_ERR:
    FTS_TEST_SAVE_INFO_RESULT("CB Test is NG\n");
    *test_result = false;
    if (tmpbuf) {
        fts_free(tmpbuf);
    }
...
int ft8716_short_test(bool *test_result)
{
    ...
    FTS_TEST_SAVE_INFO_RESULT("ShortCircuit Test is %s\n", (temp_result  ? "OK" : "NG"));
...
SHORT_TEST_ERR:
    *test_result = false;
    FTS_TEST_SAVE_INFO_RESULT("ShortCircuit Test is NG\n");
...
int ft8716u_key_short_test(bool *test_result)
{
    ...
    FTS_TEST_SAVE_INFO_RESULT("KEY Short Test is %s\n", (temp_result  ? "OK" : "NG"));
...
KEYSHORT_TEST_ERR:
    *test_result = false;
    FTS_TEST_SAVE_INFO_RESULT("KEY Short Test is NG\n");
...
int ft8716_open_test(bool *test_result)
{
    ...
    FTS_TEST_SAVE_INFO_RESULT("Open Test is %s\n", (temp_result  ? "OK" : "NG"));
...
OPEN_TEST_ERR:
    if (tmpbuf)
        fts_free(tmpbuf);
    *test_result = false;
    FTS_TEST_SAVE_INFO_RESULT("Open Test is NG\n");
...
int ft8716_lcd_noise_test(bool *test_result)
{
    ...
    FTS_TEST_SAVE_INFO_RESULT("LCD Noise Test is %s\n", (temp_result  ? "OK" : "NG"));
...
LCDNOISE_TEST_ERR:
    *test_result = false;
    FTS_TEST_SAVE_INFO_RESULT("LCD Noise Test is NG\n");
