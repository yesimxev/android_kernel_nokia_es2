 ...
 */
#ifdef  CONFIG_TOUCHSCREEN_FOCALTECH_TS_DEBUG
 ...
 * default: disable
 */
#if defined(CONFIG_TOUCHSCREEN_MTK_FTS_TPESD)
 ...
 */
#define FTS_UPGRADE_FW_FILE                      "include/firmware/ft8613_app_e2.i"

/*
 * if FTS_GET_VENDOR_ID_NUM >= 2, fw corrsponding with FTS_VENDOR_ID2
 * define your own fw_file, the sample one is invalid
 */
#define FTS_UPGRADE_FW2_FILE                     "include/firmware/ft8613_app_e2.i"

/*
 * if FTS_GET_VENDOR_ID_NUM >= 3, fw corrsponding with FTS_VENDOR_ID3
 * define your own fw_file, the sample one is invalid
 */
#define FTS_UPGRADE_FW3_FILE                     "include/firmware/ft8613_app_e2.i"
