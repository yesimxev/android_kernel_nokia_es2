...
static DEVICE_ATTR(sleepdump,      0664, FIH_gpio_show_sleepdump,   FIH_gpio_store_sleepdump);
static DEVICE_ATTR(activedump,      0664, FIH_gpio_show_activedump,   FIH_gpio_store_activedump);
#endif

/*---------------------------------------------------------------------------*/
static struct device_attribute *gpio_attr_list[] = {
#ifdef CONFIG_FIH_DUMP_GPIO2FILE
	&dev_attr_pin,&dev_attr_sleepdump,&dev_attr_activedump
#else
	&dev_attr_pin,
#endif
};
