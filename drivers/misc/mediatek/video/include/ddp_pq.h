...
#define DISP_PQ_PARAM struct DISP_PQ_PARAM_T

struct DISP_PQ_WIN_PARAM_T {
	int split_en;
	int start_x;
	int start_y;
	int end_x;
...
#define DISP_PQ_WIN_PARAM struct DISP_PQ_WIN_PARAM_T

struct DISP_PQ_MAPPING_PARAM_T {
	int image;
	int video;
	int camera;
};

#define DISP_PQ_MAPPING_PARAM struct DISP_PQ_MAPPING_PARAM_T

struct MDP_COLOR_CAP_T {
	unsigned int en;
	unsigned int pos_x;
	unsigned int pos_y;
};
#define MDP_COLOR_CAP struct MDP_COLOR_CAP_T

struct MDP_TDSHP_REG_T {
...
#define MDP_TDSHP_REG struct MDP_TDSHP_REG_T
...
struct DISP_PQ_DS_PARAM_T {
	int param[PQ_DS_INDEX_MAX];
};
#define DISP_PQ_DS_PARAM struct DISP_PQ_DS_PARAM_T
...
struct DISP_PQ_DC_PARAM_T {
	int param[PQDC_INDEX_MAX];
};
#define DISP_PQ_DC_PARAM struct DISP_PQ_DC_PARAM_T
...
#define DISP_OD_CMD struct DISP_OD_CMD_T
#endif
