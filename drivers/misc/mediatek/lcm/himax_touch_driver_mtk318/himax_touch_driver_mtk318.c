...
static void lcm_suspend(void)
{
	...
	LCM_LOGD("kernel:himax_lcm_suspend\n");
}
...
static void lcm_resume(void)
{
	...
	UDELAY(10);
#endif
	LCM_LOGD("kernel:himax_lcm_resume\n");
}
...
LCM_DRIVER himax_touch_driver_mtk318_lcm_drv =
{
    .name           	= "himax_touch_driver_mtk318",
