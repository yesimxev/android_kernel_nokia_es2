...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.PLL_CLOCK 		= 459;	//371/2;  //4lane
	...
	params->dsi.vertical_frontporch		= 110;
...
static void lcm_suspend(void)
{
	...
	LCM_LOGD("kernel:ft8719_lcm_suspend\n");
}
...
static void lcm_resume(void)
{
	...
	UDELAY(10);
#endif
	LCM_LOGD("kernel:ft8719_lcm_resume\n");
}

LCM_DRIVER ft8719_fhd_dsi_vdo_rt5081_lcm_drv =
{
    .name           	= "ft8719_fhd_dsi_vdo_rt5081",
